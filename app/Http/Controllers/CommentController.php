...
class CommentController extends Controller
{
    ...
    public function destroy(Comment $comment)
    {
        ...
        if ($comment->delete()) {
            return redirect()->route('article.show', ['article' => $article_id])->with('status', 'Delete comment success');
        } else {
            return redirect()->route('article.show', ['article' => $article_id])->with('status', 'Delete comment failed');
