            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        @can('create')
                            <li class="nav-item">
                                <a class="nav-link @active('article')" aria-current="page" href="/article/create">Create
                                    article</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @active('article')" aria-current="page" href="/comment/index">All
                                    comments</a>
                            </li>
                        @endcan
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @active('article')" href="/contacts">Контакты</a>
                        </li>
                        @auth
